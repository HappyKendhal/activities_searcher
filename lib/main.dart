...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Activities Searcher',
      theme: ThemeData(
        primarySwatch: Colors.green,
      ),
      home: SearchActivities(title: 'Activities Searcher'),
    );
  }
}

class SearchActivities extends StatefulWidget {
  SearchActivities({Key key, this.title}) : super(key: key);

  final String title;

  @override
  SearchActivitiesState createState() => SearchActivitiesState();
}

class SearchActivitiesState extends State<SearchActivities> {
